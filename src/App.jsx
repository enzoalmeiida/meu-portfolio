...
const translations = {
  pt: {
    ...
    projects: {
      ...
      antonioPortfolioDesc: 'Portfolio desenvolvido para um amigo, com foco em apresentação pessoal, visual limpo e navegação simples para destacar perfil, projetos e contato.',
  ...
  en: {
    ...
    projects: {
      ...
      antonioPortfolioDesc: 'Portfolio built for a friend, focused on personal presentation, clean visuals, and simple navigation to highlight profile, projects, and contact.',
