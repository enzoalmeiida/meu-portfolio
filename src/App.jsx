...
const translations = {
  pt: {
    ...
    about: {
      title: 'Sobre Mim',
      bioCmd: 'cat bio.txt',
      bio1: 'Sou estudante de Engenharia de Software na FIAP e um profissional obstinado por garantir a resiliência e a alta disponibilidade de sistemas críticos.',
      bio2: 'Atualmente, atuo como SRE & Infrastructure Intern na Nambbu, onde vivencio o dia a dia da operação lidando com automação de infraestrutura, monitoramento de ambientes cloud e a consolidação da cultura DevOps. Essa experiência me ensinou que o objetivo não é apenas "manter o sistema no ar", mas construir uma arquitetura inteligente que se antecipe aos problemas.',
      bio3: 'Minha base técnica é ancorada em Cloud Computing e práticas de Site Reliability Engineering. Sou certificado AWS Cloud Practitioner e, no momento, estou em reta final de preparação para a certificação Microsoft Azure Fundamentals (AZ-900), fortalecendo minha visão estratégica de ambientes Multi-Cloud.',
      bio4: 'Mais do que manter servidores rodando, meu foco é resolver problemas complexos, automatizar processos manuais e garantir que a infraestrutura seja o motor invisível e confiável de qualquer negócio.',
    ...
    projects: {
      ...
      portfolioDesc: 'Portfólio pessoal em evolução, criado para apresentar minha trajetória, projetos, experiências e formas de contato em uma interface moderna, responsiva e objetiva.',
      portfolioTech: 'React | Vite | React Router | PT/EN | PDF Preview',
      antonioPortfolioTitle: 'Portfolio Antônio',
      antonioPortfolioDesc: 'Portfólio pessoal com foco em apresentação profissional, identidade visual limpa e navegação direta, destacando sobre, projetos, links e contato em uma experiência moderna e responsiva.',
      antonioPortfolioTech: 'React | Vite | UI Responsiva | Portfolio Pessoal',
  ...
  en: {
    ...
    about: {
      title: 'About Me',
      bioCmd: 'cat bio.txt',
      bio1: 'I am a Software Engineering student at FIAP and a professional driven to ensure resilience and high availability for critical systems.',
      bio2: 'Currently, I work as an SRE & Infrastructure Intern at Nambbu, where I experience day-to-day operations with infrastructure automation, cloud environment monitoring, and DevOps culture consolidation. This experience taught me that the goal is not only to keep systems online, but to build intelligent architecture that anticipates problems.',
      bio3: 'My technical foundation is anchored in Cloud Computing and Site Reliability Engineering practices. I am AWS Cloud Practitioner certified and currently in the final stage of preparation for the Microsoft Azure Fundamentals (AZ-900) certification, strengthening my strategic view of Multi-Cloud environments.',
      bio4: 'More than keeping servers running, my focus is solving complex problems, automating manual processes, and ensuring infrastructure is the invisible and reliable engine behind any business.',
      skillsCmd: 'skills --all',
      skillsTitle: 'Skills',
      backend: 'Back-end & Scripting',
      frontend: 'Front-end',
    ...
    projects: {
      ...
      portfolioDesc: 'An evolving personal portfolio built to present my background, projects, experience, and contact options in a modern, responsive, and objective interface.',
      portfolioTech: 'React | Vite | React Router | PT/EN | PDF Preview',
      antonioPortfolioTitle: 'Antonio Portfolio',
      antonioPortfolioDesc: 'Personal portfolio focused on professional presentation, clean visual identity, and straightforward navigation, highlighting about, projects, links, and contact in a modern responsive experience.',
      antonioPortfolioTech: 'React | Vite | Responsive UI | Personal Portfolio',
      nambbuTitle: 'Nambbu Automation',
...
function ProjectsPage({ language }) {
  ...
  const projects = [
    ...
    {
      titleKey: 'antonioPortfolioTitle',
      descKey: 'antonioPortfolioDesc',
      techKey: 'antonioPortfolioTech',
      github: 'https://github.com/enzoalmeiida/portfolio-antonio',
      liveUrl: 'https://antoniozakzukduarte.me',
      category: 'personal',
